# FinalProject - Crosssubject project
...
to see the specific components I use refer to #Components and #MVP, for security see #security.

Sadly i wont fully translate the entire readme.
